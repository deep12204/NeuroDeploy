...
Backend	Python 3.11	!%20%F0%9F%90%8D-blue" target="_blank" rel="noopener noreferrer" style="color:#5A315D;text-decoration:none;border-bottom:1px solid #5A315D;font-weight:500;">Python
Web framework	FastAPI	!FastAPI
ML / Data	NumPy, Pandas, PyTorch (optional)	!ML
Database	ChromaDB (vector store)	!ChromaDB
Frontend	React 18 + Vite	!React
Styling	Tailwind CSS	!Tailwind
Containerisation	Docker, Docker‑Compose	!Docker
CI/CD	GitHub Actions	!GitHub Actions
Testing	Pytest, Jest	!Tests
...
1.
Repository Analysis – Paste a GitHub URL → the card “01 Repository Analysis” shows a short description and a progress bar.

2.
Infrastructure Generation – After analysis, the “02 Infrastructure Generation” card appears; click Generate to download a zip containing Dockerfile, docker-compose.yml, and optional K8s manifests.

3.
Resource Recommendation – The UI automatically calls /api/ml/estimate-resources and displays RAM/CPU suggestions.
...
2.
Install the development dependencies (see Getting Started).

3.
Run tests – pytest for backend, npm test for frontend.

4.
Add or update documentation in README.md or frontend/README.md.
...
3.
GitHub Actions automatically builds and pushes a multi‑arch Docker image to Docker Hub (repo-mind:latest).
